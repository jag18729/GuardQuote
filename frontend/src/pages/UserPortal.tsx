...
// OAuth config — client IDs are public (visible in redirect URL)
const OAUTH = {
  github: {
...
function oauthRedirect(provider: "github" | "google") {
  ...
  const params = new URLSearchParams({
    ...
    scope: config.scope,
    state,
    ...(provider === "google" && { response_type: "code", access_type: "online" }),
  });
...
export default function UserPortal() {
  ...
  const handleEmailAuth = (e: React.FormEvent) => {
    e.preventDefault();
    // TODO: wire to /api/auth/login or /api/auth/register
    navigate("/dashboard");
  };
      ...
      <div className={styles.authBox}>
        ...
        <p className={styles.subtitle}>
          {mode === "login"
            ...
            : "Start generating professional security quotes"}
        </p>

        {/* OAuth — one click, no forms */}
